...
<div class="example">
	<ul id="breadcrumbs">
		...
		<li>
			...
			<a href="chooseMorgueWard.page">Morgue Wards</a>
		</li>
...
<div class="patient-header new-patient-header">
	<div class="demographics">
		<h1 class="name" style="border-bottom: 1px solid #ddd;">
			<span>${morgueWard.name} &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>
		</h1>
	</div>

	<div class="identifiers">
		<em>&nbsp; &nbsp; Patients:</em>
		<span>${listAdmittedMorguePatients.size()} admitted, ${listMorgueAdmission.size()} waiting</span>
	</div>
